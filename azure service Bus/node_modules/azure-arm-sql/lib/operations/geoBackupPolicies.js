...
function _createOrUpdate(resourceGroupName, serverName, databaseName, parameters, options, callback) {
  ...
  let geoBackupPolicyName = 'Default';
  // Validate
  try {
  ...
  requestUrl = requestUrl.replace('{geoBackupPolicyName}', encodeURIComponent(geoBackupPolicyName));
  let queryParameters = [];
...
module.exports = GeoBackupPolicies;
