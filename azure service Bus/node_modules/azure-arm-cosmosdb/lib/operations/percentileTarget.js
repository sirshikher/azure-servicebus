 ...
 */
function _listMetrics(resourceGroupName, accountName, targetRegion, filter, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/targetRegion/{targetRegion}/percentile/metrics';
...
class PercentileTarget {
   ...
   */
  listMetricsWithHttpOperationResponse(resourceGroupName, accountName, targetRegion, filter, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listMetrics(resourceGroupName, accountName, targetRegion, filter, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listMetrics(resourceGroupName, accountName, targetRegion, filter, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._listMetrics(resourceGroupName, accountName, targetRegion, filter, options, optionalCallback);
    }
  }

}

module.exports = PercentileTarget;
