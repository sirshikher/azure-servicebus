 ...
 */
function _listMetrics(resourceGroupName, accountName, sourceRegion, targetRegion, filter, options, callback) {
  ...
  try {
    ...
    if (sourceRegion === null || sourceRegion === undefined || typeof sourceRegion.valueOf() !== 'string') {
      throw new Error('sourceRegion cannot be null or undefined and it must be of type string.');
    }
    if (targetRegion === null || targetRegion === undefined || typeof targetRegion.valueOf() !== 'string') {
      throw new Error('targetRegion cannot be null or undefined and it must be of type string.');
    }
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/sourceRegion/{sourceRegion}/targetRegion/{targetRegion}/percentile/metrics';
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  requestUrl = requestUrl.replace('{resourceGroupName}', encodeURIComponent(resourceGroupName));
  requestUrl = requestUrl.replace('{accountName}', encodeURIComponent(accountName));
  requestUrl = requestUrl.replace('{sourceRegion}', encodeURIComponent(sourceRegion));
  requestUrl = requestUrl.replace('{targetRegion}', encodeURIComponent(targetRegion));
  let queryParameters = [];
...
class PercentileSourceTarget {
   ...
   */
  listMetricsWithHttpOperationResponse(resourceGroupName, accountName, sourceRegion, targetRegion, filter, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listMetrics(resourceGroupName, accountName, sourceRegion, targetRegion, filter, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listMetrics(resourceGroupName, accountName, sourceRegion, targetRegion, filter, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._listMetrics(resourceGroupName, accountName, sourceRegion, targetRegion, filter, options, optionalCallback);
    }
  }

}

module.exports = PercentileSourceTarget;
