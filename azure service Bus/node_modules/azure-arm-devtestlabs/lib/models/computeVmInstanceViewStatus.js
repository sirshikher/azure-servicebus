...
class ComputeVmInstanceViewStatus {
  /**
   * Create a ComputeVmInstanceViewStatus.
  ...
  /**
   * Defines the metadata of ComputeVmInstanceViewStatus
   *
   * @returns {object} metadata of ComputeVmInstanceViewStatus
   *
   */
  mapper() {
    return {
...
module.exports = ComputeVmInstanceViewStatus;
