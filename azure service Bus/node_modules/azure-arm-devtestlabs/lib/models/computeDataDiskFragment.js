...
class ComputeDataDiskFragment {
  /**
   * Create a ComputeDataDiskFragment.
  ...
  /**
   * Defines the metadata of ComputeDataDiskFragment
   *
   * @returns {object} metadata of ComputeDataDiskFragment
   *
   */
  mapper() {
    return {
...
module.exports = ComputeDataDiskFragment;
