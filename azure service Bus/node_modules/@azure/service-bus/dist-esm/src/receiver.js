...
import { getAlreadyReceivingErrorMsg, getOpenReceiverErrorMsg, getReceiverClosedErrorMsg, throwErrorIfConnectionClosed, throwTypeErrorIfParameterMissing, throwTypeErrorIfParameterNotLong, throwTypeErrorIfParameterNotLongArray, getErrorMessageNotSupportedInReceiveAndDeleteMode } from "./util/errors";
/**
    ...
    close() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                log.error("[%s] An error occurred while closing the Receiver for %s: %O", this._context.namespace.connectionId, this._context.entityPath, err);
                throw err;
            }
        });
    }
    ...
    close() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                log.error("[%s] An error occurred while closing the SessionReceiver for session %s in %s: %O", this._context.namespace.connectionId, this.sessionId, this._context.entityPath, err);
                throw err;
            }
            finally {
                this._isClosed = true;
