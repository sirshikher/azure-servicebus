...
import { getOpenSenderErrorMsg, throwErrorIfClientOrConnectionClosed, throwErrorIfConnectionClosed } from "./util/errors";
    ...
    close() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                log.error("[%s] An error occurred while closing the TopicClient for %s: %O", this._context.namespace.connectionId, this.id, err);
                throw err;
            }
        });
    }
...
//# sourceMappingURL=topicClient.js.map