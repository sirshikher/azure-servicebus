 ...
 */
export function throwErrorIfClientOrConnectionClosed(context, entityPath, isClientClosed) {
 ...
 */
export function getOpenSenderErrorMsg(clientType, entityPath) {
 ...
 */
export function getOpenReceiverErrorMsg(clientType, entityPath, sessionId) {
    if (!sessionId) {
 ...
 * @param entityPath Value of the `entityPath` property on the client which denotes its name
 */
export function getClientClosedErrorMsg(entityPath) {
 ...
 */
export function getSenderClosedErrorMsg(entityPath, clientType, isClientClosed) {
    if (isClientClosed) {
 ...
 * @param sessionId If using session receiver, then the id of the session
 */
export function getReceiverClosedErrorMsg(entityPath, clientType, isClientClosed, sessionId) {
    if (isClientClosed) {
 ...
 */
export function getErrorMessageNotSupportedInReceiveAndDeleteMode(failedToDo) {
