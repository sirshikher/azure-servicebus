...
function _list(options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/providers/Microsoft.Consumption/reservationRecommendations';
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['ReservationRecommendationsListResult']().mapper();
...
/** Class representing a ReservationRecommendationsOperations. */
class ReservationRecommendationsOperations {
  /**
   * Create a ReservationRecommendationsOperations.
...
module.exports = ReservationRecommendationsOperations;
